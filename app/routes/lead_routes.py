...
from ..services.lead_service import (
    filter_lead, extract_lead_data, score_lead, decide_lead, 
    generate_response_text, save_lead
)
...
def process_lead(
    ...
    try:
        ...
        response_text = generate_response_text(decision, data, lead.name, lead.message, missing)
        ...
        send_centralized_email(background_tasks, decision, lead.email, lead.name, response_text)
